...
snapfit.defaultCallback = function(){ stop(); };
snapfit.defaultMatchcolor = '#00d000'; //STR '#000000'-'#ffffff'
snapfit.defaultFalsecolor = '#ff0000'; //STR '#000000'-'#ffffff'
snapfit.defaultAreacolor = '#ffffff'; //STR '#000000'-'#ffffff'
snapfit.defaultBgrndcolor = '#ffffff'; //STR '#000000'-'#ffffff'
...
snapfit.defaultAreaopacity = 1; //FLOAT 0.0-1.0 background area/image opacity
